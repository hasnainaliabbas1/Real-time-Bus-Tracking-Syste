                      ...
                      <CardContent>
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <p className="font-medium">{subscription.plan?.description || 'No description available'}</p>
                            <p className="text-sm mt-1">
                              Price: <span className="font-medium">{subscription.plan ? formatCurrency(subscription.plan.price) : 'Unknown'}</span>
                            </p>
                          </div>
                        </div>
                      </CardContent>
            ...
            <div className="py-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span>{format(addDays(new Date(), selectedPlan.duration), 'MMM d, yyyy')}</span>
                </div>
              </div>
            </div>
          )}
